...
import { getPublicEvent, isPublicId, listPublicMatches, listPublicStandings, listPublicTeams } from '@/lib/db/repositories/public-scores'
...
export default async function PublicLivePage({ params }: { params: Promise<{ eventId: string }> }) {
  ...
  if (!isPublicId(eventId)) notFound()
